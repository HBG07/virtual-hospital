                    ...
                    <div class="row mt-4">
                        <div class="col-6">
                            <div class="form-group form-check form-switch">
                                <input class="form-check-input" value="1" type="checkbox" name="anciano_solo" id="anciano_solo">
                                <label class="form-check-label" for="anciano_solo">Anciano Solo</label>
                            </div>
                            <div class="form-group form-check form-switch">
                                <input class="form-check-input" value="1" type="checkbox" name="app" id="ap">
                                <label class="form-check-label" for="ap">App</label>
                            </div>
                            <div class="form-group form-check form-switch">
                                <input class="form-check-input" value="1" type="checkbox" name="encamado" id="encamado">
                                <label class="form-check-label" for="encamado">Encamado</label>
                            </div>
                            <div class="form-group form-check form-switch">
                                <input class="form-check-input" value="1" type="checkbox" name="VIH" id="VIH">
                                <label class="form-check-label" for="VIH">VIH</label>
                            </div>
                            <div class="form-group form-check form-switch">
                                <input class="form-check-input" value="1" type="checkbox" name="diambulante" id="deambulante">
                                <label class="form-check-label" for="deambulante">Deambulante</label>
                            </div>
                            <div class="form-group form-check form-switch">
                                <input class="form-check-input" value="1" type="checkbox" name="familia_riesgo" id="familia_riesgo">
                                <label class="form-check-label" for="familia_riesgo">Familia con riesgo</label>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group form-check form-switch">
                                <input class="form-check-input" value="1" type="checkbox" name="embarazada" id="embarazada">
                                <label class="form-check-label" for="embarazada">Embarazada</label>
                            </div>
                            <div class="form-group form-check form-switch">
                                <input class="form-check-input" value="1" type="checkbox" name="puerpera" id="puerpera">
                                <label class="form-check-label" for="puerpera">Puerpera</label>
                            </div>
                            <div class="form-group form-check form-switch">
                                <input class="form-check-input" value="1" type="checkbox" name="contacto" id="contacto">
                                <label class="form-check-label" for="contacto">Contacto</label>
                            </div>
                            <div class="form-group form-check form-switch">
                                <input class="form-check-input" value="1" type="checkbox" name="inmunodeprimido" id="inmunodeprimido">
                                <label class="form-check-label" for="inmunodeprimido">Inmunodeprimido</label>
                            </div>
                            <div class="form-group form-check form-switch">
                                <input class="form-check-input" value="1" type="checkbox" name="t_salud" id="t_salud">
                                <label class="form-check-label" for="t_salud">Trabajador de la salud</label>
                            </div>
                            <div class="form-group form-check form-switch">
                                <input class="form-check-input" value="1" type="checkbox" name="t_turismo" id="t_turismo">
