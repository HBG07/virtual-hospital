...
@section('content')
    ...
    <form action="{{ route('pesquisa.store') }}" method="post">
        ...
        <div class=" form-group">
            ...
            <input list="CI_pesquisados" class="form-control" type="text" name="CI_pesquisado" id="CI" value="{{ old('CI_pesquisado') }}">
        ...
        <div class=" form-group">
            ...
            <input list="nombre_pesquisados" class="form-control" type="text" name="nombre" id="nombre" value="{{ old('nombre') }}">
        ...
        <div class=" form-group">
            ...
            <input list="primer_apellido_pesquisados" class="form-control" type="text" name="primer_apellido" id="primer_apellido" value="{{ old('nombre') }}">
        ...
        <div class=" form-group">
            ...
            <input list="segundo_apellido_pesquisados" class="form-control" type="text" name="segundo_apellido" id="segundo_apellido" value="{{ old('nombre') }}">
